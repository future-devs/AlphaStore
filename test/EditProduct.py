...
class AppDynamicsJob(unittest.TestCase):
    ...
    def test_app_dynamics_job(self):
        ...
        driver.find_element_by_xpath("//button[@onclick=\"editProduct(this,'P68')\"]").click()
        driver.find_element_by_id("add-name").click()
        driver.find_element_by_id("add-name").clear()
        driver.find_element_by_id("add-name").send_keys("Sample Test Product")
        driver.find_element_by_id("add-specifications").click()
        driver.find_element_by_id("add-specifications").clear()
        driver.find_element_by_id("add-specifications").send_keys("This is a specification for edit")
        driver.find_element_by_id("add-tags").click()
        driver.find_element_by_id("add-tags").clear()
        driver.find_element_by_id("add-tags").send_keys("NEW, SAMPLE, Test")
